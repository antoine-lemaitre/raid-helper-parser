from extractor import raid_extractor, raid_extractor_by_character, find_character, clean_date, find_character_with_attendance_stats
import click
import json
import datetime
...
def selector(extractor, find, before_date, after_date, character, stats):
